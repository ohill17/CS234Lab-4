...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=127.0.0.1;uid=root;pwd=C@tsat11;port=3307;database=bits", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.1.0-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Adjunct>(entity =>
        {
            ...
            entity.HasOne(d => d.RecommendedUseDuring).WithMany(p => p.Adjuncts)
        ...
        modelBuilder.Entity<Equipment>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "equipment_name_UNIQUE").IsUnique();
        ...
        modelBuilder.Entity<Fermentable>(entity =>
        {
            ...
            entity.HasOne(d => d.FermentableType).WithMany(p => p.Fermentables)
        ...
        modelBuilder.Entity<Hop>(entity =>
        {
            ...
            entity.HasOne(d => d.HopType).WithMany(p => p.Hops)
        ...
        modelBuilder.Entity<Recipe>(entity =>
        {
            ...
            entity.HasOne(d => d.Equipment).WithMany(p => p.Recipes)
                .HasForeignKey(d => d.EquipmentId)
                .HasConstraintName("recipe_equipment_FK");

            entity.HasOne(d => d.Mash).WithMany(p => p.Recipes)
                .HasForeignKey(d => d.MashId)
        ...
        modelBuilder.Entity<RecipeIngredient>(entity =>
        {
            ...
            entity.HasOne(d => d.UseDuring).WithMany(p => p.RecipeIngredients)
